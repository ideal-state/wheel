...
package team.idealstate.minecraft.forge.wheel.mod;
...
public class Wheel {
    ...
    @SidedProxy(
            clientSide = "team.idealstate.minecraft.forge.wheel.mod.proxy.ClientProxy",
            serverSide = "team.idealstate.minecraft.forge.wheel.mod.proxy.CommonProxy"
    )
